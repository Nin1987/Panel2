        ...
        <div class="row p-5 pt-3">
            <div class="col-2">
                <ul class="scoria-menu link-menu">
                    <li class="bottom-black-border"><a href="" class="fc-color6">Portfel</a></li>
                    <li><a href="" class="fc-color6">Produkty</a></li>
                    <li><a href="" class="fc-color6">Oferty</a></li>
                    <li><a href="" class="fc-color6">Umowa</a></li>
                </ul>
            </div>
            <div class="col-10">
                <div class="row">
